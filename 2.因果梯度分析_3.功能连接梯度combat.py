...
INPUT_ROOT = Path(r"I:\DYF\NPI-4-code\2.梯度分析\功能梯度\ABIDE2_功能梯度_群体模板")
OUTPUT_ROOT = Path(r"I:\DYF\NPI-4-code\2.梯度分析\功能梯度\ABIDE2_功能梯度_群体模板_comabt")
...
GRADIENT_FILES = {
    "G1": "FC_G1_procrustes.npy",
    "G2": "FC_G2_procrustes.npy",
}
